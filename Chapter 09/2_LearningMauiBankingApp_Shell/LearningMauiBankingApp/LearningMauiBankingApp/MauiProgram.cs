...
public static class MauiProgram
{
	public static MauiApp CreateMauiApp()
	{
        ...
        builder.Services.AddTransientServiceUsingContainer<StrongContainer, CustomPage1>();
        builder.Services.AddTransientServiceUsingContainer<StrongContainer, CustomPage2>();
        builder.Services.AddTransientServiceUsingContainer<StrongContainer, CustomPage3>();
        ...
        builder.Services.AddTransientServiceUsingContainer<StrongContainer, ConfirmationModalPage>();
        builder.Services.AddTransientServiceUsingContainer<StrongContainer, ConfirmationModalPageViewModel>();
